                ...
                {isNetworkError && (
                  <Alert className="border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/30">
                    ...
                    <AlertDescription className="text-orange-800 dark:text-orange-200">
                      <strong>Network Error:</strong> It looks like there&apos;s
                      a connection issue. Please check your internet connection
                      and try again.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                {isAuthError && (
                  <Alert className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/30">
                    ...
                    <AlertDescription className="text-blue-800 dark:text-blue-200">
                      <strong>Authentication Error:</strong> Your session may
                      have expired. Please try logging in again.
                    </AlertDescription>
                  </Alert>
                )}
